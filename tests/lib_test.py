...
test_parse_subject_data = [
    ("", 0, "foo", 0, 0, "foo.bar",
        [], [], [], "bar", "protobuf", None),
    ("", 0, "foo", 0, 0, "foo.bar.protobuf",
        [], [], [], "bar", "protobuf", None),
    ("", 0, "foo", 0, 0, "foo.bar.json",
        [], [], [], "bar", "json", None),
    ("", 0, "foo", 0, 0, "foo.bar.json.protobuf",
        [], [], [], "bar", "",
        (nrpc.lib.InvalidSubject,
            "subject tail is too long")),
    ("demo", 0, "foo", 0, 0, "demo.foo.bar",
        [], [], [], "bar", "protobuf", None),
    ("demo", 0, "foo", 0, 0, "demo.foo.bar.json",
        [], [], [], "bar", "json", None),
    ("demo", 0, "foo", 0, 0, "foo.bar.json",
        [], [], [], "", "",
        (nrpc.lib.InvalidSubject,
            "subject should start with demo")),
    ("demo", 2, "foo", 0, 0, "demo.p1.p2.foo.bar.json",
        ["p1", "p2"], [], [], "bar", "json", None),
    ("demo", 2, "foo", 1, 0, "demo.p1.p2.foo.sp1.bar.json",
        ["p1", "p2"], ["sp1"], [], "bar", "json", None),
    ("demo.pkg", 1, "nested.svc", 1, 0, "demo.pkg.p1.nested.svc.sp1.bar",
        ["p1"], ["sp1"], [], "bar", "protobuf", None),
]
