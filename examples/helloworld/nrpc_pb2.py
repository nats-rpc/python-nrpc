...
_SUBJECTRULE = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="COPY", index=0, number=0, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="TOLOWER", index=1, number=1, options=None, type=None
        ),
    ],
...
_ERROR_TYPE = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="CLIENT", index=0, number=0, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="SERVER", index=1, number=1, options=None, type=None
        ),
    ],
    containing_type=None,
    options=None,
...
_RPCRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="result",
            full_name="nrpc.RPCResponse.result",
            index=0,
            number=1,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="error",
            full_name="nrpc.RPCResponse.error",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
    ...
    oneofs=[
        _descriptor.OneofDescriptor(
            name="reply",
            full_name="nrpc.RPCResponse.reply",
            index=0,
            containing_type=None,
            fields=[],
        ),
...
_RPCRESPONSE.fields_by_name["result"].containing_oneof = _RPCRESPONSE.oneofs_by_name[
    "reply"
]
_RPCRESPONSE.oneofs_by_name["reply"].fields.append(_RPCRESPONSE.fields_by_name["error"])
_RPCRESPONSE.fields_by_name["error"].containing_oneof = _RPCRESPONSE.oneofs_by_name[
    "reply"
]
...
RPCResponse = _reflection.GeneratedProtocolMessageType(
    "RPCResponse",
    (_message.Message,),
    dict(
...
DESCRIPTOR._options = _descriptor._ParseOptions(
    descriptor_pb2.FileOptions(), _b("Z\031github.com/rapidloop/nrpc")
)
