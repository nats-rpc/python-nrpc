...
_SIMPLESTRINGREPLY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="reply",
            full_name="main.SimpleStringReply.reply",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
StringArg = _reflection.GeneratedProtocolMessageType(
    "StringArg",
    (_message.Message,),
    {
...
SimpleStringReply = _reflection.GeneratedProtocolMessageType(
    "SimpleStringReply",
    (_message.Message,),
    {
